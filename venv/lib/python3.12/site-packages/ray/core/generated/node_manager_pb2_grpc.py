...
class NodeManagerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RemovePlacementGroupBundles = channel.unary_unary(
                '/ray.rpc.NodeManagerService/RemovePlacementGroupBundles',
                request_serializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.RemovePlacementGroupBundlesRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.RemovePlacementGroupBundlesReply.FromString,
                )
...
class NodeManagerServiceServicer(object):
    ...
    def RemovePlacementGroupBundles(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_NodeManagerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RemovePlacementGroupBundles': grpc.unary_unary_rpc_method_handler(
                    servicer.RemovePlacementGroupBundles,
                    request_deserializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.RemovePlacementGroupBundlesRequest.FromString,
                    response_serializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.RemovePlacementGroupBundlesReply.SerializeToString,
            ),
...
class NodeManagerService(object):
    ...
    @staticmethod
    def RemovePlacementGroupBundles(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.NodeManagerService/RemovePlacementGroupBundles',
            src_dot_ray_dot_protobuf_dot_node__manager__pb2.RemovePlacementGroupBundlesRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_node__manager__pb2.RemovePlacementGroupBundlesReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
