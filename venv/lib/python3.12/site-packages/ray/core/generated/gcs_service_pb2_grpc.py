...
class ControlPlanePubSubGcsServiceStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        self.GcsPublish = channel.unary_unary(
                '/ray.rpc.ControlPlanePubSubGcsService/GcsPublish',
        ...
        self.GcsSubscriberPoll = channel.unary_unary(
                '/ray.rpc.ControlPlanePubSubGcsService/GcsSubscriberPoll',
        ...
        self.GcsSubscriberCommandBatch = channel.unary_unary(
                '/ray.rpc.ControlPlanePubSubGcsService/GcsSubscriberCommandBatch',
...
class ControlPlanePubSubGcsServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ControlPlanePubSubGcsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ray.rpc.ControlPlanePubSubGcsService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class ControlPlanePubSubGcsService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def GcsPublish(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.ControlPlanePubSubGcsService/GcsPublish',
    ...
    def GcsSubscriberPoll(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.ControlPlanePubSubGcsService/GcsSubscriberPoll',
    ...
    def GcsSubscriberCommandBatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.ControlPlanePubSubGcsService/GcsSubscriberCommandBatch',
...
class ObservabilityPubSubServiceStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        """
        self.GcsPublish = channel.unary_unary(
                '/ray.rpc.ObservabilityPubSubService/GcsPublish',
                request_serializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsPublishRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsPublishReply.FromString,
                )
        self.ReportJobError = channel.unary_unary(
                '/ray.rpc.ObservabilityPubSubService/ReportJobError',
        ...
        self.GcsSubscriberPoll = channel.unary_unary(
                '/ray.rpc.ObservabilityPubSubService/GcsSubscriberPoll',
                request_serializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsSubscriberPollRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsSubscriberPollReply.FromString,
                )
        self.GcsSubscriberCommandBatch = channel.unary_unary(
                '/ray.rpc.ObservabilityPubSubService/GcsSubscriberCommandBatch',
                request_serializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsSubscriberCommandBatchRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsSubscriberCommandBatchReply.FromString,
                )


class ObservabilityPubSubServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ObservabilityPubSubServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GcsPublish': grpc.unary_unary_rpc_method_handler(
                    servicer.GcsPublish,
                    request_deserializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsPublishRequest.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ray.rpc.ObservabilityPubSubService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class ObservabilityPubSubService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def GcsPublish(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.ObservabilityPubSubService/GcsPublish',
            src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsPublishRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsPublishReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ReportJobError(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.ObservabilityPubSubService/ReportJobError',
    ...
    def GcsSubscriberPoll(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.ObservabilityPubSubService/GcsSubscriberPoll',
            src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsSubscriberPollRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsSubscriberPollReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GcsSubscriberCommandBatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.ObservabilityPubSubService/GcsSubscriberCommandBatch',
            src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsSubscriberCommandBatchRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GcsSubscriberCommandBatchReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
